<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="FoodOrder.Login" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="card">
            <table>
                ...
                <tr>
                    <td></td>
                    <td><asp:Button CssClass="btn mt-3 text-white btn-outline-white btn-md my-0 ml-sm-2" runat="server" BackColor="#0099FF" OnClick="Login_btn" Text="Login" /></td>
                </tr>      
                <tr>
                    <td class="pt-3">Didn't have an account <asp:LinkButton ID="LinkButton1" PostBackUrl="~/Signup.aspx" runat="server">Signup here..</asp:LinkButton></td>
                </tr>  
            </table>
        </div>
    </form>
